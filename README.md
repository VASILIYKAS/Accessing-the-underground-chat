...
Добавлен графический клиент для подключения и регистрации в чате MineChat.
...
- [Как запустить](#как-запустить)
    - [Как запустить с графическим интрефейсом](#как-запустить-с-графическим-интерфейсом)
...
## Как запустить с графическим интерфейсом
Если вы используете чат впервые, сначала зарегистрируйтесь:
```bash
python register_user.py
```
Программа откроет графическое окно, где вы сможете ввести имя. После регистрации данные сохранятся в файл `register_info.json`.

После регистрации запустите основной клиент:
```bash
python run_chat.py
```
Чат автоматически загрузит ваши регистрационные данные и подключится к серверу.
